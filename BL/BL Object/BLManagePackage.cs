    ...
    public partial class BL : IBL
    {
        ...
        public void AssignPackageToDrone(int id)
        {
            lock (dal) {
                ...
                if (drone.Status != DroneStatus.free) { throw new DroneNotFreeException("assign package"); }
        ...
        public void CollectPackageByDrone(int id)
        {
            lock (dal) {
                ...
                if (drone.PackageId is null) { throw new DroneNotAssignedPackageException(); }

                var package = dal.GetPackage(drone.PackageId!.Value);

                if (package.PickedUp is not null) { throw new PackageAlreadyPickedUpException(); }
        ...
        public void DeliverPackageByDrone(int id)
        {
            lock (dal) {
                ...
                if (package.PickedUp is null) { throw new PackageAlreadyPickedUpException(); }
